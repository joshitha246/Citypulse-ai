  ...
  if (query.includes('predict') || query.includes('forecast') || query.includes('next 24')) {
    return {
      html: `
        ...
        <p class="metric-line">💬 LLM Engine: Gemini 2.5 Flash</p>
        <p class="metric-line">⚡ Deployment Target: NVIDIA H200 GPU</p>
        ...
        <p style="margin-top:12px;"><strong>LLM Reasoning</strong><br>The recommendation is generated by combining historical complaint trends, simulated weather indicators, and previous municipal response patterns. The language summary is produced by the LLM, while incident classification is handled by the deep learning model.</p>
      `,
      actions: [
